    ...
    function create(uint256 qty) public payable nonReentrant {
        ...
        for (uint256 i; i < qty; i++) {
            ...
            Detail memory newDetail = Detail({
                hair: IOniiChainDescriptor(_tokenDescriptor).generateHairId(
                    nextTokenId,
                    seed
                ),
                eye: IOniiChainDescriptor(_tokenDescriptor).generateEyeId(
                    nextTokenId,
                    seed
                ),
                eyebrow: IOniiChainDescriptor(_tokenDescriptor)
                    .generateEyebrowId(nextTokenId, seed),
                nose: IOniiChainDescriptor(_tokenDescriptor).generateNoseId(
                    nextTokenId,
                    seed
                ),
                mouth: IOniiChainDescriptor(_tokenDescriptor).generateMouthId(
                    nextTokenId,
                    seed
                ),
                mark: IOniiChainDescriptor(_tokenDescriptor).generateMarkId(
                    nextTokenId,
                    seed
                ),
                earrings: IOniiChainDescriptor(_tokenDescriptor)
                    .generateEarringsId(nextTokenId, seed),
                accessory: IOniiChainDescriptor(_tokenDescriptor)
                    .generateAccessoryId(nextTokenId, seed),
                mask: IOniiChainDescriptor(_tokenDescriptor).generateMaskId(
                    nextTokenId,
                    seed
                ),
                skin: IOniiChainDescriptor(_tokenDescriptor).generateSkinId(
                    nextTokenId,
                    seed
                ),
                original: true,
...
interface IOniiChainDescriptor {
    ...
    function tokenURI(IOniiChain oniiChain, uint256 tokenId)
        external
        view
        returns (string memory);
...
library EyesDetail {
    ...
    function eyesNoFillAndColorPupils(
        string memory scleraColor,
        string memory pupilsColor
    ) private pure returns (string memory) {
        return
            base(
                string(
                    abi.encodePacked(
                        eyesNoFill(scleraColor),
                        colorPupils(pupilsColor)
                    )
                )
            );
    }
    ...
    function eyesNoFillAndBlankPupils(
        string memory scleraColor,
        string memory pupilsColor
    ) private pure returns (string memory) {
        return
    ...
    function eyesNoFill(string memory scleraColor)
        private
        pure
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    eyeLeftNoFill(scleraColor),
                    eyeRightNoFill(scleraColor)
                )
            );
    }

    /// @dev Eye right and no fill
    function eyeRightNoFill(string memory scleraColor)
        private
        pure
        returns (string memory)
    {
    ...
    /// @dev Eye right and no fill
    function eyeLeftNoFill(string memory scleraColor)
        private
        pure
        returns (string memory)
    {
    ...
    function colorPupils(string memory pupilsColor)
        private
        pure
        returns (string memory)
    {
    ...
    function blankPupils(string memory pupilsColor)
        private
        pure
        returns (string memory)
    {
