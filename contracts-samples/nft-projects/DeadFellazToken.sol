...
contract DeadFellazToken is IERC721, Ownable, ERC721Enumerable {
    ...
    uint256 public constant MAX_MINT_AMOUNT = 13;

    uint256 public constant MAX_PRIZE_MINTS = 2_000;
    ...
    function mintPrizes(uint256 amount) public onlyOwner {
        uint256 currentTotalSupply = totalSupply();

        /// @notice Prize mints must mint first, and cannot be minted after the maximum has been reached
        require(
            currentTotalSupply < MAX_PRIZE_MINTS,
            "DeadFellazToken: Max prize mint limit reached"
        );
